...
@section('content')
  ...
  <section class="min-vh-100 mt-7">
    <div class="page-header align-items-start min-vh-70 pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url('../assets/img/fyp-family-3.jpg'); background-position:5px 40%" >
        <span class="mask bg-gradient-dark opacity-6"></span> <!-- Reduced opacity -->
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              <h1 class="text-white mb-2 mt-5">Selamat Datang!</h1>
              <p class="text-lead text-white">Ketahui pandangan tentang perkembangan anak anda <br> Daftar sekarang!</p>
            </div>
          </div>
        </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="row px-xl-5 px-sm-4 px-3">
              ...
              <div class="d-flex justify-content-center align-items-center" style="min-height: 10vh;">
                <div class="col-3 px-1">
                  <a class="btn btn-outline-light d-flex justify-content-center align-items-center" href="javascript:;" style="width: 80px; height: 80px;">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                @csrf
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Nama pengguna" name="username" id="username" aria-label="userName" aria-describedby="username" value="{{ old('username') }}">
                  @error('username')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="E-mel" name="email" id="email" aria-label="Email" aria-describedby="email-addon" value="{{ old('email') }}">
                  @error('email')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Kata laluan" name="password" id="password" aria-label="Password" aria-describedby="password-addon">
                  @error('password')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="form-check form-check-info text-left">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    Saya bersetuju dengan <a href="javascript:;" class="font-weight-bolder" style="color: #3F51B2;">Terma dan Syarat</a>
                  </label>
                  @error('agreement')
                ...
                <p class="text-sm mt-3 mb-0">Sudah mempunyai akaun? <a href="login" class="font-weight-bolder" style="color: #3F51B2;">Log Masuk</a></p>
              </form>
            </div>
          </div>
        </div>
