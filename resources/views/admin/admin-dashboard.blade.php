                        ...
                        <tbody>
                            @if ($tips)
                                <tr>
                                    ...
                                    <td class="align-middle text-xs">Tip-tip</td>
                                    <td class="align-middle text-center text-xs">
                                        {{ $tips->updated_at->format('Y-m-d H:i:s') }}
                                    </td>
                                </tr>
                            @else
                                <tr>
                                    <td colspan="3" class="align-middle text-center text-xs">
                                        No tips available.
                                    </td>
                                </tr>
                            @endif
                            ...
                            @if ($interventions)
                                <tr>
                                    ...
                                    <td class="align-middle text-xs">Intervensi</td>
                                    <td class="align-middle text-center text-xs">
                                        {{ $interventions->updated_at->format('Y-m-d H:i:s') }}
                                    </td>
                                </tr>
                            @else
                                <tr>
