...
<div class="container">
    ...
    <button type="button" class="btn btn-primary" style="float: right" onclick="location.href='{{ route('growth-tracking.create') }}'">Tambah Data</button>-->
    <a href="{{ route('growth-tracking.create') }}" style="float: right" class="btn btn-primary">+&nbsp;Tambah Data</a>
</div>
<br>
<br>
@endsection
