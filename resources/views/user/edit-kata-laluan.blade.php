...
<div class="container mt-5">
    <div class="card-header pb-0">
        ...
        <div class="card-body pt-4 p-3">
            <form
                action="{{ route('update-password.updatePassword', ['childId' => $childId ?? Auth::user()->children->first()->id]) }}"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" placeholder="Masukkan Kata Laluan Sekarang"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" placeholder="Masukkan Kata Laluan Baru"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" placeholder="Sahkan Kata Laluan Baru"
                ...
                <div class="row">
                    <div class="col-6">
                        <!-- Button Kembali (Left) -->
                        <a href="{{ route('user-details.showParentDetail', ['childId' => request('childId', Auth::user()->children->first()->id)]) }}"
