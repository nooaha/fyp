    ...
    <div class="container mt-5">
        ...
        <div class="card-header pb-0">
            ...
            <div class="header-row mb-3">
                <h5 class="font-weight-bold">Senarai Tips</h5>
                <!-- "Tambah" button aligned to the right -->
                <button type="button" class="btn btn-success btn-sm btn-add" onclick="window.location.href='/tambah-tips'">Tambah</button>
            </div>
                        ...
                        <tbody id="categoryTableBody">
                            <tr>
                                ...
                                <td class="action-column">
                                    <button class="btn btn-warning btn-sm" onclick="window.location.href='/edit-tips'">Edit</button>
