...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex justify-content-center m-0 navbar-brand text-wrap" href="{{route('user-dashboard')}}">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle {{ (Request::is('user-dashboard') ? 'active' : '') }}" href="{{ url('user-dashboard') }}" id="childDropdown" data-bs-toggle="collapse" data-bs-target="#childAccordion" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <img src="../assets/img/logos/dashboard-logo.png" alt="Custom Icon" width="12" height="12">
            </div>
      ...
      <!--Nav Graph-->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('graf-tumbesaran-anak') ? 'active' : '') }}" href="{{ url('graf-tumbesaran-anak') }}">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          <img src="../assets/img/logos/graf-icon.png" alt="Custom Icon" width="12" height="12">
        </div>
      ...
      <li class="nav-item">
        ...
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          <img src="../assets/img/logos/milestone-icon.png" alt="Custom Icon" width="12" height="12">
        </div>
      ...
      <li class="nav-item">
        ...
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          <img src="../assets/img/logos/mchat-icon.png" alt="Custom Icon" width="12" height="12">
        </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('tips-dan-intervensi') ? 'active' : '') }}" href="{{ url('tips-dan-intervensi') }}">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          <img src="../assets/img/logos/tips-icon.png" alt="Custom Icon" width="12" height="12">
        </div>
